...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-surface to-white flex">
      {/* Sidebar */}
      <aside className="w-64 bg-white border-r border-gray-200 shadow-sm fixed h-screen flex flex-col">
        {/* Logo */}
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg text-foreground">Equippe</h1>
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 text-foreground text-sm font-medium rounded-xl transition-colors flex items-center justify-center gap-2"
          >
